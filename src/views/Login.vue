      ...
      <div class="login-container">
        <div class="login-form-column">
          <form v-on:submit.prevent="authLoginUser" >
            ...
            <div class="form-wrapper">
              ...
              <input type="text" name="username" id="username" v-model="username" placeholder="Enter your name" class="form-control" required>
            </div>
        ...
        <div class="login-image-column">
          <div class="image-holder">
            <img src="../assets/login-illustration.svg" alt="login icon">
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    authLoginUser() {
      const apiKey = process.env.VUE_APP_COMMETCHAT_API_KEY
